...
def train(_class_, pars):
    ...
    save_model_path  = pars.save_folder + '/' + _class_ + '/' + model_type+'_'+_class_+'.pth'
    ...
    for epoch in tqdm(range(1,num_epoch+1)):
        ...
        plt.savefig(pars.save_folder + '/' + _class_ + '/' + model_type + '_monitor_traning.png', dpi = 100)
        ...
        if (auroc_px + auroc_sp + aupro_px) / 3 > best_score:
            ...
            with open(os.path.join(pars.save_folder + '/' + _class_ , f'{model_type}_history.json'), 'w') as f:
...
if __name__ == '__main__':
    ...
    metrics_path = f'{pars.save_folder}/metrics_results.csv'
